            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="alamatJenazah" required><br>
                        <table>
                            <tr>
                                <td>a. Kelurahan</td><td><input type="text" name="kelurahanJenazah" required></td>
                                <td>c. Kab/Kota</td><td><input type="text" name="kotaJenazah" required></td>
                            </tr>
                            <tr>
                                <td>b. Kecamatan</td><td><input type="text" name="kecamatanJenazah" required></td>
                                <td>d. Provinsi</td><td><input type="text" name="provinsiJenazah" required></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="alamatIbu" required><br>
                        <table>
                            <tr>
                                <td>a. Kelurahan</td><td><input type="text" name="kelurahanIbu" required></td>
                                <td>c. Kab/Kota</td><td><input type="text" name="kotaIbu" required></td>
                            </tr>
                            <tr>
                                <td>b. Kecamatan</td><td><input type="text" name="kecamatanIbu" required></td>
                                <td>d. Provinsi</td><td><input type="text" name="provinsiIbu" required></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="alamatAyah" required><br>
                        <table>
                            <tr>
                                <td>a. Kelurahan</td><td><input type="text" name="kelurahanAyah" required></td>
                                <td>c. Kab/Kota</td><td><input type="text" name="kotaAyah" required></td>
                            </tr>
                            <tr>
                                <td>b. Kecamatan</td><td><input type="text" name="kecamatanAyah" required></td>
                                <td>d. Provinsi</td><td><input type="text" name="provinsiAyah" required></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="alamatPelapor" required><br>
                        <table>
                            <tr>
                                <td>a. Kelurahan</td><td><input type="text" name="kelurahanPelapor" required></td>
                                <td>c. Kab/Kota</td><td><input type="text" name="kotaPelapor" required></td>
                            </tr>
                            <tr>
                                <td>b. Kecamatan</td><td><input type="text" name="kecamatanPelapor" required></td>
                                <td>d. Provinsi</td><td><input type="text" name="provinsiPelapor" required></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="alamatSaksi1" required><br>
                        <table>
                            <tr>
                                <td>a. Kelurahan</td><td><input type="text" name="kelurahanSaksi1" required></td>
                                <td>c. Kab/Kota</td><td><input type="text" name="kotaSaksi1" required></td>
                            </tr>
                            <tr>
                                <td>b. Kecamatan</td><td><input type="text" name="kecamatanSaksi1" required></td>
                                <td>d. Provinsi</td><td><input type="text" name="provinsiSaksi1" required></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="alamatSaksi2" required><br>
                        <table>
                            <tr>
                                <td>a. Kelurahan</td><td><input type="text" name="kelurahanSaksi2" required></td>
                                <td>c. Kab/Kota</td><td><input type="text" name="kotaSaksi2" required></td>
                            </tr>
                            <tr>
                                <td>b. Kecamatan</td><td><input type="text" name="kecamatanSaksi2" required></td>
                                <td>d. Provinsi</td><td><input type="text" name="provinsiSaksi2" required></td>
                            </tr>
                        </table>
                    </td>
                </tr>
