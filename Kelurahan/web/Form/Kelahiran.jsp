        ...
        <form action="" method="POST">
            <table>
                ...
                <tr>
                    ...
                    <td>Berat bayi</td>
                    <td>:</td>
                    <td><input type="number" name="berat" min="1" step="0.01" required> Kg</td>
                </tr>
                <tr>
                    <td>11. </td>
                    <td>Panjang bayi</td>
                    <td>:</td>
                    <td><input type="number" name="panjang" min="1" required> cm</td>
                </tr>
                ...
                <tr>
                    ...
                    <td>Umur</td>
                    <td>:</td>
                    <td><input type="number" name="umurPelapor" min="10" required> Tahun</td>
                </tr>
                <tr>
                    <td>4. </td>
                    <td>Jenis Kelamin</td>
                ...
                <tr>
                    ...
                    <td>Umur</td>
                    <td>:</td>
                    <td><input type="number" name="umurSaksi1" min="10" required> Tahun</td>
                </tr>
                <tr>
                    <td>4. </td>
                    <td>Pekerjaan</td>
                ...
                <tr>
                    ...
                    <td>Umur</td>
                    <td>:</td>
                    <td><input type="number" name="umurSaksi2" min="10" required> Tahun</td>
                </tr>
                <tr>
                    <td>4. </td>
                    <td>Pekerjaan</td>
